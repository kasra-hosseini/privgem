...
def plot_log(filename, method_name="PATE-CTGAN", show_or_save="show"):
    ...
    acc_student = [float(x.split("|")[7].split("Acc (student): ")[1]) for x in body]
    acc_gen = [float(x.split("|")[8].split("Acc (generator): ")[1]) for x in body]
